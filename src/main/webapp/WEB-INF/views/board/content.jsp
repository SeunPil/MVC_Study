        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal" id="modal-close">닫기</button>
                </div>
            </div>
        </div>
    </div>
            ...
            function makeReplyListDOM(replyMap) {
                ...
                function makePageDOM(pageInfo) {
                    ...
                    for (let i = begin; i <= end; i++) {
                        ...
                        tag += "<li class='page-item' " + active + "><a class='page-link page-custom " +
                            active + "' href='" +
                            i + "'>" +
                            i + "</a></li>";
                    }
                    ...
                    //다음 버튼 만들기
                    if (pageInfo.next) {
                        tag += "<li class='page-item'><a class='page-link p-active' href='" + (end + 1) +
                            "'>다음</a></li>";
                    }
